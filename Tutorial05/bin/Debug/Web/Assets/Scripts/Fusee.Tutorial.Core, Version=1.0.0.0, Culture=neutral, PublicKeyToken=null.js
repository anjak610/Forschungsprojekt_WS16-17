...
(function Tutorial$Members () {
  ...
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm09.Fusee.Tutorial.Core.SceneOb)) ();
  };
  var $T08 = function () {
  ...
  function Tutorial_Init () {
    var vs = $T02().Get$b1($T01())("VertexShader.vert");
    var ps = $T02().Get$b1($T01())("PixelShader.frag");
    var sceneContainer = $T02().Get$b1($T03())("wuggy.fus");
    var shaderProgram = (this.RenderCanvas$RC$value).CreateShader(vs, ps);
    ...
    var sceneOb = new ($T07())();
    var expr_88 = JSIL.Array.New($T07(), 8);
    var expr_8F = new ($T07())();
    expr_8F.Mesh = mesh;
    expr_8F.Pos = $S00().Construct(0, 2.75, 0);
    expr_8F.ModelScale = $S00().Construct(0.5, 1, 0.25);
    expr_8F.Albedo = $S00().Construct(0.2, 0.6, 0.3);
    expr_88[0] = expr_8F;
    var expr_ED = new ($T07())();
    expr_ED.Mesh = mesh2;
    expr_ED.Pos = $S00().Construct(-0.25, 1, 0);
    expr_ED.ModelScale = $S00().Construct(0.15, 1, 0.15);
    expr_88[1] = expr_ED;
    var expr_131 = new ($T07())();
    expr_131.Mesh = mesh2;
    expr_131.Pos = $S00().Construct(0.25, 1, 0);
    expr_131.ModelScale = $S00().Construct(0.15, 1, 0.15);
    expr_88[2] = expr_131;
    var expr_175 = new ($T07())();
    expr_175.Mesh = mesh3;
    expr_175.Pos = $S00().Construct(-0.75, 3.5, 0);
    expr_175.ModelScale = $S00().Construct(0.25, 0.25, 0.25);
    expr_88[3] = expr_175;
    var expr_1B9 = new ($T07())();
    expr_1B9.Mesh = mesh3;
    expr_1B9.Pos = $S00().Construct(0.75, 3.5, 0);
    expr_1B9.ModelScale = $S00().Construct(0.25, 0.25, 0.25);
    expr_88[4] = expr_1B9;
    var expr_1FD = new ($T07())();
    expr_1FD.Mesh = mesh2;
    expr_1FD.Pos = $S00().Construct(-0.75, 2.5, 0);
    expr_1FD.ModelScale = $S00().Construct(0.15, 1, 0.15);
    expr_88[5] = expr_1FD;
    var expr_241 = new ($T07())();
    expr_241.Mesh = mesh2;
    expr_241.Pos = $S00().Construct(0.75, 2.5, 0);
    expr_241.ModelScale = $S00().Construct(0.15, 1, 0.15);
    expr_88[6] = expr_241;
    var expr_285 = new ($T07())();
    expr_285.Mesh = mesh3;
    expr_285.Pos = $S00().Construct(0, 4.2, 0);
    expr_285.ModelScale = $S00().Construct(0.35, 0.5, 0.35);
    expr_285.Albedo = $S00().Construct(0.9, 0.6, 0.5);
    expr_88[7] = expr_285;
    sceneOb.Children = $S01().Construct($T0B().$Cast(expr_88));
    this._root = sceneOb;
  ...
  function Tutorial_LoadMesh (assetName) {
    var arg_2D_1 = null;
    var sceneContainer = $T02().Get$b1($T03())(assetName);
    var arg_2D_0 = sceneContainer.Children;
    if ((arg_2D_1 = $T0F().$l$g9__5_0) === null) {
      arg_2D_1 = $T0F().$l$g9__5_0 = $T0D().New($T0F().$l$g9, null, new JSIL.MethodPointerInfo($asm09.Fusee.Tutorial.Core.Tutorial_$l$gc, "$lLoadMesh$gb__5_0", $S03(), false, false));
    }
  ...
  function Tutorial_ModelXForm (pos, rot, pivot) {
    return $S06().CallStatic($T13(), "op_Multiply", null, 
      $S06().CallStatic($T13(), "op_Multiply", null, 
        $S06().CallStatic($T13(), "op_Multiply", null, 
          $S06().CallStatic($T13(), "op_Multiply", null, 
            $T13().CreateTranslation($T09().op_Addition(pos.MemberwiseClone(), pivot).MemberwiseClone()).MemberwiseClone(), 
      ...
      $T13().CreateTranslation($T09().op_UnaryNegation(pivot.MemberwiseClone()).MemberwiseClone()).MemberwiseClone()
    );
  }; 
...
(function $l$gc$Members () {
  ...
  function $l$gc_$lLoadMesh$gb__5_0 (c) {
    return true;
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "$lLoadMesh$gb__5_0", 
      new JSIL.MethodSignature($.Boolean, [$asm07.TypeRef("Fusee.Serialization.MeshComponent")]), 
      $l$gc_$lLoadMesh$gb__5_0
    );

    $.Field({Static:true , Public:true , ReadOnly:true }, "$l$g9", $.Type);

    $.Field({Static:true , Public:true }, "$l$g9__5_0", $asm14.TypeRef("System.Predicate`1", [$asm07.TypeRef("Fusee.Serialization.MeshComponent")]));
