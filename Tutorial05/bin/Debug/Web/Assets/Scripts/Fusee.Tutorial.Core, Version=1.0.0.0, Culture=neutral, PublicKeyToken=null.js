...
(function PointCloud$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize(System.Array.Of($asm06.Fusee.Math.Core.float3))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize(System.Array.Of($asm14.System.Single))) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "_colors", $jsilcore.TypeRef("System.Array", [$asm06.TypeRef("Fusee.Math.Core.float3")]));

    $.Field({Static:false, Public:false}, "_echoIds", $jsilcore.TypeRef("System.Array", [$.Single]));

    $.Field({Static:false, Public:false}, "_scanNrs", $jsilcore.TypeRef("System.Array", [$.Single]));

    $.Property({Static:false, Public:true }, "Vertices", $jsilcore.TypeRef("System.Array", [$asm06.TypeRef("Fusee.Math.Core.float3")]));

    $.Property({Static:false, Public:true }, "Colors", $jsilcore.TypeRef("System.Array", [$asm06.TypeRef("Fusee.Math.Core.float3")]));

    $.Property({Static:false, Public:true }, "EchoIds", $jsilcore.TypeRef("System.Array", [$.Single]));

    $.Property({Static:false, Public:true }, "ScanNrs", $jsilcore.TypeRef("System.Array", [$.Single]));
...
(function PointVisualizationBase$Members () {
  ...
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0F.System.Diagnostics.Debug)) ();
  };
  var $T04 = function () {
  ...
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm04.Fusee.Engine.Core.Mesh)) ();
  };
  var $T07 = function () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(JSIL.MethodSignature.Action($asm0D.TypeRef("System.Object")))) ();
  };
  var $S01 = function () {
  ...
  function PointVisualizationBase_Init () {
    var pointCloud = $T02().Get$b1($T01())("test_points.ipm");
    $S00().CallStatic($T03(), "WriteLine", null, pointCloud.get_Vertices());
    ...
    var mesh = new ($T06())();
    mesh.set_Vertices(JSIL.Array.New($T07(), [$S01().Construct(-0.75, -0.75, 0), $S01().Construct(0.75, -0.75, 0), $S01().Construct(0, 0.75, 0)]));
    mesh.set_Triangles(JSIL.Array.New($T08(), [0, 1, 2, 3]));
    this._mesh = mesh;
  ...
  function PointVisualizationBase_LoadMesh (assetName) {
    var arg_2D_1 = null;
    var sceneContainer = $T02().Get$b1($T0C())(assetName);
    var arg_2D_0 = sceneContainer.Children;
    if ((arg_2D_1 = $T0E().$l$g9__3_0) === null) {
      arg_2D_1 = $T0E().$l$g9__3_0 = $T0B().New($T0E().$l$g9, null, new JSIL.MethodPointerInfo($asm09.Fusee.Tutorial.Core.PointVisualizationBase_$l$gc, "$lLoadMesh$gb__3_0", $S03(), false, false));
    }
    var meshComponent = $S04().CallStatic($T10(), "First$b1", [$asm07.Fusee.Serialization.MeshComponent], $S05().CallStatic($T11(), "FindComponents$b1", [$asm07.Fusee.Serialization.MeshComponent], arg_2D_0, arg_2D_1));
    var expr_3D = new ($T06())();
  ...
  function PointVisualizationBase_ModelXForm (pos, rot, pivot) {
    return $S06().CallStatic($T12(), "op_Multiply", null, 
      $S06().CallStatic($T12(), "op_Multiply", null, 
        $S06().CallStatic($T12(), "op_Multiply", null, 
          $S06().CallStatic($T12(), "op_Multiply", null, 
            $T12().CreateTranslation($T07().op_Addition(pos.MemberwiseClone(), pivot).MemberwiseClone()).MemberwiseClone(), 
      ...
      $T12().CreateTranslation($T07().op_UnaryNegation(pivot.MemberwiseClone()).MemberwiseClone()).MemberwiseClone()
    );
  }; 

  function PointVisualizationBase_PrintVertices () {
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false}, "PrintVertices", 
      JSIL.MethodSignature.Void, 
      PointVisualizationBase_PrintVertices
    );
