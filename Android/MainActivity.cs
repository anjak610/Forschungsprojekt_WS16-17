...
namespace Fusee.Tutorial.Android
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            dialog.OnNewPortCallbacks += OnNewPortEntered;
        ...
        /// <summary>
        /// Gets called when the user enters a new port to listen to.
        /// </summary>
        private void OnNewPortEntered(int port)
        {
            app.SetUDPPort(port);
        }
