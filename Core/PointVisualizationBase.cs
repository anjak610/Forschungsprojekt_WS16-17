...
namespace Fusee.Tutorial.Core
{
    ...
    public class PointVisualizationBase : RenderCanvas
    {
       ...
       private float2 _zBounds = float2.Zero;
        ...
        private static float  _zoomVel, _angleHorz = M.PiOver6 * 2.0f, _angleVert = -M.PiOver6 * 0.5f, _angleVelHorz, _angleVelVert, _angleRoll, _angleRollInit;
        ...
        public override void RenderAFrame()
        {
           ...
           // ChangeParticleSize();
            ...
            RC.Projection = _projection;//TODO:Warum wird das nicht geupdated??
        ...
        public void GetZoomValue(ShaderProgram shader, float _zoom)
        {
